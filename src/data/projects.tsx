...
const projects: Project[] = [
  ...
  { // 05. Chess Game
    ...
    category: "Game",
    title: "Chess Game",
    src: "/assets/projects-screenshots/chess/4.png",
    screenshots: ["01.jpeg"],
    live: "https://github.com/alienxviking/chess-pygame",
    github:"https://github.com/alienxviking/chess-pygame",
    skills: {
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
          A complete chess game built with Pygame, featuring both Player vs Player and Player vs AI modes. The AI is powered by the Stockfish API with three selectable difficulty levels. All official chess rules are implemented, including castling, en passant, and pawn promotion with a dedicated selection menu. The game also offers three interchangeable board themes for a customizable experience.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
              `${BASE_PATH}/chess/1.png`,
              `${BASE_PATH}/chess/2.png`,
              `${BASE_PATH}/chess/3.png`,
            ]}
          />
        </div>
      );
